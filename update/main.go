...
func makeReadme(filename string) error {
	...
	blog := "You might like my latest blog post: **[" + blogItem.Title + "](" + blogItem.Link + ")**. You can subscribe to my [**blog RSS**](https://calvineotieno010.medium.com/) or by email at [**https://calvineotieno010.medium.com/**](https://https://calvineotieno010.medium.com/)."
